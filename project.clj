(defproject binaryage/craigslist-tools "0.1.0-SNAPSHOT"
  :dependencies [[org.clojure/clojure "1.9.0-RC1"]
                 [org.clojure/clojurescript "1.9.946"]
                 [org.clojure/core.async "0.3.465"]
                 [binaryage/chromex "0.5.13"]
                          ...
                          {:background
                           {:source-paths ["src/background"]
                            ...
                            :compiler     {:output-to     "resources/unpacked/compiled/background/main.js"
                                           ...
                                           :main          craigslist-tools.background
                                           :optimizations :none
                                           :source-map    true}}
                           :popup
                          ...
                          {:content-script
                           {:source-paths ["src/content_script"]
                            :compiler     {:output-to     "resources/unpacked/compiled/content-script/main.js"
                                           ...
                                           :main          craigslist-tools.content-script
